...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [499] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 6, .production_id = 19),
  [501] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 3, .production_id = 4),
  [503] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 3),
  [505] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 5, .production_id = 19),
  ...
  [511] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 4, .production_id = 4),
  [513] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 4, .production_id = 4),
  [515] = {.entry = {.count = 1, .reusable = true}}, SHIFT(195),
  [517] = {.entry = {.count = 1, .reusable = true}}, SHIFT(246),
  [519] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 3, .production_id = 4),
